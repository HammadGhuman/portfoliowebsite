...
export default function page() {
  ...
  return (
   <div className="">
    ...
    <main className="min-h-screen bg-gradient-to-r  from-[#DF4848] to-[#4400a6]">
    <Navbar open={open} setOpen={setOpen}/>
      <div className='flex items-center justify-center px-4 lg:flex-row  flex-col'>
        ...
        <p className="lg:text-7xl text-4xl font-bold max-w-3xl text-start text-white">We prioritize customers, deliver innovative digital solutions through collaboration.</p>
