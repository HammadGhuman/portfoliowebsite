   ...
   <div className="">
    ...
    <Navbar open={open} setOpen={setOpen}/>
      <div className='flex items-center justify-center px-4 lg:flex-row  flex-col'>
        ...
        <p className="lg:text-6xl text-4xl font-bold max-w-3xl text-start text-white">We are a <span className="capitalize text-primary"> customer-first</span> software development team offering quality solutions in best value</p>
